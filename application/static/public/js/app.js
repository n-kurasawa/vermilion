...
},{"./actions/ScoreActions":227,"./stores/ScoreStore":237,"flummox":4}],227:[function(require,module,exports){
'use strict';
...
var ScoreActions = (function (_Actions) {
  function ScoreActions() {
    ...
    socket.connect();
    var chan = socket.chan('scores:join');
    chan.join('scores:join', {}).receive('ok', function (_ref) {
    ...
    chan.on('new_score', (function (payload) {
      _this.getScore(payload.body);
    }).bind(this));

    chan.on('reset_score', (function (payload) {
      _this.resetScore();
    }).bind(this));
...
},{"../vendor/phoenix":238,"flummox":4}],228:[function(require,module,exports){
'use strict';
...
var AdminAppHandler = (function (_React$Component) {
  function AdminAppHandler(props) {
    _classCallCheck(this, AdminAppHandler);

    _get(Object.getPrototypeOf(AdminAppHandler.prototype), 'constructor', this).call(this, props);
  }

  _inherits(AdminAppHandler, _React$Component);

  _createClass(AdminAppHandler, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'button',
          { className: 'rest_btn', onClick: this.handleReset.bind(this) },
          'リセット'
        )
      );
    }
  ...
  return AdminAppHandler;
})(_react2['default'].Component);

exports['default'] = AdminAppHandler;
module.exports = exports['default'];

},{"./ScoreInput.jsx":232,"./ScoreList.jsx":234,"./ScoreSummary.jsx":235,"flummox/component":2,"react":225}],229:[function(require,module,exports){
'use strict';
...
},{"../Flux":226,"../routes":236,"flummox/component":2,"react":225,"react-router":38}],230:[function(require,module,exports){
'use strict';
...
},{"./ScoreInput.jsx":232,"./ScoreList.jsx":234,"./ScoreSummary.jsx":235,"flummox/component":2,"react":225,"react-router":38}],231:[function(require,module,exports){
'use strict';
...
},{"./ScoreInput.jsx":232,"./ScoreList.jsx":234,"./ScoreSummary.jsx":235,"flummox/component":2,"react":225,"react-router":38}],232:[function(require,module,exports){
"use strict";
...
},{"./ScoreItem.jsx":233,"flummox/component":2,"react":225}],235:[function(require,module,exports){
"use strict";
...
var _componentsAdminAppHandlerJsx = require('./components/AdminAppHandler.jsx');

var _componentsAdminAppHandlerJsx2 = _interopRequireDefault(_componentsAdminAppHandlerJsx);
...
exports['default'] = _react2['default'].createElement(
  ...
  _react2['default'].createElement(
    _reactRouter.Route,
    { name: 'home', path: '/', handler: _componentsHomeHandlerJsx2['default'] },
    _react2['default'].createElement(_reactRouter.Route, { name: 'admin', path: '/admin', handler: _componentsAdminAppHandlerJsx2['default'] })
  ),
  _react2['default'].createElement(_reactRouter.Redirect, { from: '*', to: 'home' })
);
module.exports = exports['default'];

},{"./components/AdminAppHandler.jsx":228,"./components/AppHandler.jsx":230,"./components/HomeHandler.jsx":231,"react":225,"react-router":38}],237:[function(require,module,exports){
'use strict';
...
},{"flummox":4}],238:[function(require,module,exports){
